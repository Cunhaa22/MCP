...
class Transform:
    ...
    async def translate(
        ...
        for key, value in tranParams.items():
            ...
            try:
                tranParams[key] = await self.__CheckParam.doCheck(value)
        ...
        if destination != "":
            try:
                await self.__Component.ensureExistence(destination)
            except RuntimeError:
                raise RuntimeError(
    ...
    async def rotate(self, object: str, x: Union[float, str], y: Union[float, str],
               z: Union[str, float], x0: Union[float, str]=0.0,
               y0: Union[float, str]=0.0, z0: Union[float, str]=0.0,
    ...
    async def mirror(self, object: str, x: Union[float, str], y: Union[float, str],
               z: Union[str, float], x0: Union[float, str]=0.0,
               y0: Union[float, str]=0.0, z0: Union[float, str]=0.0,
               origin: str="object", copy: bool=False, repetitions: int=1,
               group=False, destination: str="", material: str=""):
