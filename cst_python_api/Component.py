...
class Component:
    ...
    async def delete(self, name: str):
        ...
        doesExist = await self.exist(name)
        if not doesExist:
            raise ValueError(
    ...
    async def rename(self, name: str, newName: str):
    ...
    async def exist(self, name: str):
        ...
        result = await self.__MWS.Component.DoesExist(name)
        
        return result
    
    async def ensureExistence(self, name: str):
