...
class Parameter:
    ...
    async def exist(self, paramName):
    ...
    async def add(self, paramName, paramValue, checkParamExistence=True):
        ...
        if await self.exist(paramName) and checkParamExistence == True:
    ...
    async def change(self, paramName, paramValue):
        ...
        await self.add(paramName, paramValue, False)
        
    async def delete(self, paramName):
        ...
        if not await self.exist(paramName):
    ...
    async def retrieve(self, paramName, paramFormat):
    ...
    async def addDescription(self, paramName, description):
    ...
    async def retrieveDescription(self, paramName):
