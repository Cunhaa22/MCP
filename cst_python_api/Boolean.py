...
class Boolean:
    ...
    async def add(self, object1: str, object2: str):
    ...
    async def subtract(self, object1: str, object2: str):
    ...
    async def intersect(self, object1: str, object2: str):
    ...
    async def insert(self, object1: str, object2: str):
    ...
    async def mergeCommonMaterials(self, component: str):
